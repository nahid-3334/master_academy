...
func main() {
	...
	nl, err := net.Listen("tcp",":888") //1 to 65535
	if err != nil {
	...
	body := `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title></title></head><body><strong>Welcome to coding boot camp BY master-acdemy</strong></body></html>`
